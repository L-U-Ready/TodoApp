...
function getTodos(){
    ...
    xhr.open("get","http://15.165.236.3:8080/api/todos");
...
function updateTodo(id){
    ...
    xhr.open('PATCH','http://15.165.236.3:8080/api/todos/'+id);
...
function deleteTodo(id){
    let delTodo = {"id": id};
    let xhr = new XMLHttpRequest();
    xhr.open('DELETE','http://15.165.236.3:8080/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
...
function postTodo(todo){
    let xhr = new XMLHttpRequest();
    xhr.open('post','http://15.165.236.3:8080/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xhr.onload = function(){
